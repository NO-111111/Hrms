...
public interface userDao  {
    ...
    @Update("update user set nickname=#{nickname},name=#{name},phonenum=#{phonenum},email=#{email},province=#{province},city=#{city},area=#{area},street=#{street},age=#{age},sex=#{sex} where user_id=#{user_id}")
